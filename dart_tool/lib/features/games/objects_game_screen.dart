...
class ObjectsGameScreen extends StatefulWidget {
  const ObjectsGameScreen({super.key});

  @override
  State<ObjectsGameScreen> createState() => _ObjectsGameScreenState();
}

class _ObjectsGameScreenState extends State<ObjectsGameScreen> {
  ...
  void _checkAnswer() {
    ...
    final isCorrect = GameValidator.isCorrectObjectsAnswer(
      selected: _chosen,
      targets: _items,
    ...
    if (isCorrect) {
      LocalDataService.instance.recordGameScore('objects');
          ...
          content: Column(
            ...
            children: [
              Container(
                ...
                child: const Text(
                  'You recalled all target objects! Today’s game progress has been updated.',
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      _isShowingPhase
                          ? 'Take a quiet moment to remember these.'
                      ...
                      if (_submitted && _isCorrect != null)
                        GameFeedbackBanner(
                          ...
                          message: _isCorrect == true
                              ? LocalDataService.instance.localizations.wonderfulRecall
                              : LocalDataService.instance.localizations.notQuite,
                          hint: _isCorrect == false
                              ? LocalDataService.instance.localizations.objectsHint
                              : null,
